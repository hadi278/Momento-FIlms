...
const FooterSection = () => {
  return (
    <>
      <footer class="w-full max-w-[85rem] pb-28 px-4 sm:px-6 lg:px-8 mx-auto">
        {/* <!-- Grid --> */}
        <div class="text-center">
          <div>
            <a
              class="flex-none text-xl font-semibold text-[#EEEEEE] dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="#"
              aria-label="Brand"
            >
              Momento Films
          ...
          <div class="mt-3">
            ...
            <p class="text-gray-500">
              © Momento Films. 2024 All rights reserved.
            </p>
          </div>
